			...
			<div class="ui segment task"
    			...
    			<div class="ui grid">
    				<div class="left floated twelve wide column">
    					...
    					<input type="checkbox" nmae="task" v-on:click="$parent.toggleDone($event, task.id)" :checked="task.completed">
      ...
      tasks: [
        {
          id: 1,
          name: 'Todo 1',
          description: 'This is a todo not completed',
          completed: true
        },
        {
          id: 2,
        ...
        },
        {
          id: 3,
          name: 'Todo 3',
          description: 'This is a todo completed',
          completed: true
        },
        {
          id: 4,
          name: 'Todo 4',
          description: 'This is a todo completed hahah',
          completed: true
        }
      ],
      task: {},
